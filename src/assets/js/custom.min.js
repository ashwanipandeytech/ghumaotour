! function(a) {
    function b() { a(".grid").masonry({ itemSelector: ".grid-item" }) }
    document.addEventListener("DOMContentLoaded", function() {
        window.addEventListener("scroll", function() {

            if (document.querySelector(".top-header") != null) {
